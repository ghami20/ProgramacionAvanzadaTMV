...
public class DetallePedido {
    ...
    public DetallePedido(int id, int pedidoId, String descripcion, int cantidad) {
        this.id = id;
    ...
    public String toString() {
        return "DetallePedido [id=" + id + ", pedidoId=" + pedidoId + ", descripcion=" + descripcion + ", cantidad=" + cantidad + "]";
    }

    public static void agregarDetalle(DetallePedido detalle) {
        try {
            PreparedStatement stmt = con.prepareStatement(
                "INSERT INTO detalle_pedido (pedido_id, descripcion, cantidad) VALUES (?, ?, ?)"
            );
    ...
    public static LinkedList<DetallePedido> obtenerDetallesPorPedido(int pedidoId) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                detalles.add(new DetallePedido(id, pedidoId, descripcion, cantidad));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
